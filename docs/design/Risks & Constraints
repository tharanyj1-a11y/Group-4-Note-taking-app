...
- **Security risks:** If the project online, there might be security vulnerabilities or data leaks.  
...
- **Design constraint:** The final design must follow the instructor’s guidelines and class requirements.
